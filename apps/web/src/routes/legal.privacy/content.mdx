...
The website refers to all public-facing informational pages on [focuscat.app](https://focuscat.app). This includes content such as homepage, product descriptions, legal documents, and support resources.
